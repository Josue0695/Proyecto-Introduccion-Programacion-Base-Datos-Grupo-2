[DB SistemaReparaciones 1.sql](https://github.com/user-attachments/files/26041582/DB.SistemaReparaciones.1.sql)
--Creacion de DB
...
FROM Tecnicos T
LEFT JOIN Asignaciones A ON T.TecnicoID = A.TecnicoID
GROUP BY T.Nombre;
